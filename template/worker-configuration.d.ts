/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=config/type-bindings.env --strict-vars=false` (hash: b30792256fa13c88cd1d87600231130f)
...
interface __BaseEnv_Env {
	...
	MEMORY_UPDATE_INTERVAL: string;
	PUBLIC_BASE_URL: string;
	TELEGRAM_BOT_TOKEN: string;
	DEEPSEEK_API_KEY: string;
	TELEGRAM_WEBHOOK_SECRET: string;
	OWNER_PAIRING_CODE: string;
	VISION_MODEL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEEPSEEK_MODEL" | "DEEPSEEK_THINKING_MODE" | "MAX_OUTPUT_TOKENS" | "DAILY_MESSAGE_LIMIT" | "MEMORY_UPDATE_INTERVAL" | "PUBLIC_BASE_URL" | "TELEGRAM_BOT_TOKEN" | "DEEPSEEK_API_KEY" | "TELEGRAM_WEBHOOK_SECRET" | "OWNER_PAIRING_CODE" | "VISION_MODEL">> {}
}
